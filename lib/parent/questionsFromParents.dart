...
class _QuestionsByParentsState extends State<QuestionsByParents> {
  Widget quizQuestion(String _questionno, String _imagepath, String _question,
    ...
    return Container(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Divider(),
            quizQuestion('1', 'assets/apple.jpg', 'Which fruit is this?',
                "Apple", "Banana", "Orange", "Mango"),
            Divider(),
            quizQuestion('2', 'assets/banana.jpg', 'Which fruit is this?',
